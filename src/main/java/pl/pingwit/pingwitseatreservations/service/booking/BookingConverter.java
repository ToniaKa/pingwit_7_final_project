...
public class BookingConverter {
    ...
    public Booking convertToEntity(CreateBookingDto createBookingDto) {
        ...
        Session session = getSession(createBookingDto);
    ...
    private Session getSession(CreateBookingDto createBookingDto) {
        return createBookingDto.getReservedSeats().stream()
